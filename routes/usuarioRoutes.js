...
router.get('/:id', usuarioController.getUsuarioById); // Função para obter um usuário por ID (corrigido para "getUsuarioById")
...
router.put('/:id', usuarioController.updateUsuario); // Função para atualizar um usuário (corrigido para "updateUsuario")

// Rota para deletar um usuário específico
router.delete('/:id', usuarioController.deleteUsuario); // Função para deletar um usuário (corrigido para "deleteUsuario")
